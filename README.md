...
*   Post. Contendrá fecha y lista de comentarios. Además, podrá ser de tipo texto (que deberá tener un String con el contenido y un título), de tipo imagen (deberá tener un título y dimensiones) o de tipo vídeo (que tendrá título, calidad y duración en segundos).
...
*   Crear una clase principal con un menú para poder seleccionar la funcionalidad que se quiera realizar.
